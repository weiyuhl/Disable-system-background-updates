...
if (!class_exists('Da_updates')) {
    ...
    class Da_updates
    {
        ...
        public function add_admin_pages()
        {
            ...
            add_submenu_page('tools.php', '禁止更新设置', '禁止更新设置', 'manage_options', 'Disable-updates', [$this, 'view']);
        ...
        public function meta($links = [], $file = "")
        {
            if (strpos($file, "Disable-updates/Disable-updates.php") !== false) {
                $new_link = [
                    "donation" => '<a href="https://github.com/hekailiu-2512/ChatGPT-Next-Web" target="_blank">GITHUB</span></a>'
                ];
        ...
        public function ads_action_links($links, $plugin_file)
        {
            ...
            if ($plugin === $plugin_file) {
                $ads_links = [
                    '<a href="' . admin_url('tools.php?page=Disable-updates') . '">设置</a>',
                ];
